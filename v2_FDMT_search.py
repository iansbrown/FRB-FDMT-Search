...
for p in xrange(16):
    ...
    filepath = '/mnt/astrodata/MWA/pksfrb_fdmt_cubes/1113366704/' + filename + '_f_t_XX-image.fits' # fits file containing data with axes y,x,f,t
    ...
    outdir = '/home/bwu/pksfrb/1113366704_results/' # fill this in
    ...
    for i in xrange(num):
        ...
        plt.title('['+str(top+y_lst[i])+','+str(left+x_lst[i])+'] S/N = %.2f' %SNR_lst[i]\
              , size=18)
